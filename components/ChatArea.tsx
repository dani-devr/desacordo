...
const MentionText: React.FC<{ content: string }> = ({ content }) => {
  // Regex to find mentions: @everyone, @here, or @Username
  // We split the string by spaces to safely analyze tokens, or use a complex regex replacer
...
const ChatArea: React.FC<ChatAreaProps> = ({ 
  ...
  const formatTime = (date: Date) => {
    // Ensure date is a valid Date object (socket data might be a string)
  ...
  return (
    <div className="flex-1 flex flex-col bg-[#313338] min-w-0">
      {/* Chat Header */}
      <div className="h-12 border-b border-[#26272d] shadow-sm flex items-center px-4 flex-shrink-0">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar flex flex-col px-4 pt-4">
        ...
        {messages.map((msg, index) => {
          ...
          // Simple logic to group messages: same sender and less than 5 minutes apart
